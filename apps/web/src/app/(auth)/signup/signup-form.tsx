    ...
    return (
      <div className="flex min-h-[80vh] items-center justify-center px-4">
        <div className="w-full max-w-sm text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900">OTP পাঠানো হয়েছে!</h2>
          <p className="mt-2 text-sm text-gray-500">
            {phone} নম্বরে একটি ভেরিফিকেশন কোড পাঠানো হয়েছে।
          </p>
          <Link href="/login">
            <Button className="mt-6 w-full">লগইন পেজে যান</Button>
          </Link>
        </div>
      </div>
    );
    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-4 text-xl font-semibold text-gray-900">রেজিস্ট্রেশন</h1>
          <p className="mt-1 text-sm text-gray-500">একাউন্ট খুলতে আপনার তথ্য দিন</p>
        </div>
