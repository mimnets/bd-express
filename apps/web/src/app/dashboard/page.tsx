...
export default function DashboardPage() {
  ...
  const quickActions = [
    { href: "/get-started", icon: ShoppingBag, label: t("dash.newOrder"), color: "bg-blue-500" },
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/dashboard/orders" className="text-sm text-blue-600 hover:underline flex items-center gap-1">{t("dash.viewAll")} <ArrowRight className="h-3 w-3" /></Link>
            </div>
            <Card className="text-center py-12">
              ...
              <Link href="/get-started"><Button className="mt-4">{t("dash.startOrder")}</Button></Link>
            </Card>
          </div>
          ...
          <div className="space-y-6">
            <Card>
              ...
              <div className="mt-3 space-y-2 text-sm text-gray-600">
                <p className="flex justify-between"><span>{t("dash.mobile")}</span><span className="font-medium text-gray-900">০১৭XX-XXXXXX</span></p>
                <p className="flex justify-between"><span>{t("dash.totalOrders")}</span><span className="font-medium text-gray-900">০</span></p>
                <p className="flex justify-between"><span>{t("dash.member")}</span><span className="font-medium text-green-600">{t("dash.free")}</span></p>
              </div>
            </Card>

            <Card className="bg-blue-50 border-blue-100">
              <h3 className="font-semibold text-blue-900">{t("dash.needHelp")}</h3>
              <p className="mt-2 text-sm text-blue-700">{t("dash.helpMsg")}</p>
              <Link href="/contact">
                <Button variant="outline" size="sm" className="mt-3 border-blue-300 text-blue-700">{t("dash.contactWhatsApp")}</Button>
              </Link>
            </Card>
          </div>
        </div>
