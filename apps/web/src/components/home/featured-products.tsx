...
const FEATURED_PRODUCTS = [
  ...
  },
  {
    ...
    titleEn: "Men's Casual Cotton T-Shirt",
    priceBdt: 228,
    priceCny: 12,
    categoryEn: "Fashion",
    categoryBn: "ফ্যাশন",
    ...
    <section className="bg-gray-50 py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between">
          ...
          <Link
            href="/products"
            className="hidden items-center gap-1 text-sm font-medium text-rose-600 hover:text-rose-700 sm:flex"
          >
          ...
          {FEATURED_PRODUCTS.map((product) => (
            <Link key={product.id} href={`/products/${product.id}`}>
              <Card className="group h-full overflow-hidden p-0 transition-shadow hover:shadow-md">
                <div className="flex h-48 items-center justify-center bg-gradient-to-br from-rose-50 to-rose-100">
                ...
                <div className="p-4">
                  ...
                  <h3 className="mt-1 font-medium text-gray-900 transition-colors group-hover:text-rose-600">
