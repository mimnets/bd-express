        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-6 text-sm text-gray-500">
            <span className="flex items-center gap-1.5">
              <ShieldCheck className="h-4 w-4 text-green-500" />{t("hero.securePayment")}
            </span>
            <span className="flex items-center gap-1.5">
              <Truck className="h-4 w-4 text-blue-500" />{t("hero.doorDelivery")}
            </span>
            <span className="flex items-center gap-1.5">
              <Banknote className="h-4 w-4 text-green-500" />{t("hero.bkashSupport")}
            </span>
          </div>
