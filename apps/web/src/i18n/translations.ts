...
export const translations = {
  ...
  // ─── Hero ───────────────────────────────────────
  "hero.badge": { en: "🇧🇩 Bangladesh's #1 China Sourcing Platform", bn: "🇧🇩 বাংলাদেশের #১ চায়না সোর্সিং প্ল্যাটফর্ম" },
  ...
  "hero.subtitle": { en: "Order from Taobao, 1688, Alibaba — any Chinese platform. Pay with bKash, Nagad, or card. We deliver to your address.", bn: "Taobao, 1688, Alibaba — যেকোনো চায়নিজ প্ল্যাটফর্ম থেকে পণ্য অর্ডার করুন। পেমেন্ট করুন bKash, Nagad বা কার্ডে। আমরা পৌঁছে দেব আপনার ঠিকানায়।" },
  ...
  "hero.stat3": { en: "৳15/CNY", bn: "৳১৫/=CNY" },
  ...
  "how.subtitle": { en: "Ordering from China is now as easy as 6 simple steps", bn: "চায়না থেকে পণ্য অর্ডার করা এখন ৬টি সহজ ধাপে" },
  "how.step1.title": { en: "Submit Link", bn: "লিংক সাবমিট" },
  "how.step1.desc": { en: "Paste your Taobao/1688 product link or browse our catalog", bn: "Taobao/1688 পণ্যের লিংক পেস্ট করুন অথবা আমাদের ক্যাটালগ থেকে বাছাই করুন" },
  "how.step2.title": { en: "Get Quote", bn: "কোটেশন গ্রহণ" },
  "how.step2.desc": { en: "See a complete breakdown of product cost, shipping, and customs", bn: "পণ্যের দাম, শিপিং, কাস্টমস — সম্পূর্ণ ব্রেকডাউন-সহ কোটেশন দেখুন" },
  "how.step3.title": { en: "Pay in BDT", bn: "পেমেন্ট করুন" },
  "how.step3.desc": { en: "Pay securely via bKash, Nagad, Rocket, or card", bn: "bKash, Nagad, Rocket বা কার্ডে টাকা পরিশোধ করুন" },
  "how.step4.title": { en: "China Sourcing", bn: "চায়না থেকে সংগ্রহ" },
  "how.step4.desc": { en: "Our China team purchases, inspects, and prepares your items for shipping", bn: "আমাদের চায়না টিম পণ্য ক্রয় করে, কোয়ালিটি চেক করে এবং শিপিংয়ের ব্যবস্থা করে" },
  "how.step5.title": { en: "Track Shipment", bn: "শিপিং ট্র্যাকিং" },
  "how.step5.desc": { en: "Air (7-12 days) or Sea (20-40 days) — get updates at every step", bn: "এয়ার (৭-১২দিন) বা সি (২০-৪০দিন) — প্রতিটি স্টেপের আপডেট পান" },
  "how.step6.title": { en: "Door Delivery", bn: "দোরগোড়ায় ডেলিভারি" },
  "how.step6.desc": { en: "Customs cleared and delivered to your address in Bangladesh", bn: "কাস্টমস ক্লিয়ারেন্স-সহ পণ্য পৌঁছে যাবে আপনার ঠিকানায়" },

  // ─── Featured Products ──────────────────────────
  "featured.title": { en: "Popular Products", bn: "জনপ্রিয় পণ্য" },
  "featured.subtitle": { en: "Featured items from our curated catalog", bn: "আমাদের কিউরেটেড ক্যাটালগ থেকে জনপ্রিয় পণ্যসমূহ" },
  "featured.viewAll": { en: "View All Products", bn: "সব পণ্য দেখুন" },

  // ─── Why Choose Us ──────────────────────────────
  "why.title": { en: "Why Choose BDXpress", bn: "কেন আমরা" },
  "why.subtitle": { en: "Reasons to choose BDXpress for your China sourcing needs", bn: "BDXpress বেছে নেওয়ার কারণসমূহ" },
  "why.secure.title": { en: "Secure Transactions", bn: "নিরাপদ লেনদেন" },
  "why.secure.desc": { en: "All payments secured through SSLCommerz. Your money is completely safe.", bn: "SSLCommerz-এর মাধ্যমে সকল পেমেন্ট সুরক্ষিত। আপনার টাকা সম্পূর্ণ নিরাপদ।" },
  "why.fast.title": { en: "Fast Delivery", bn: "দ্রুত ডেলিভারি" },
  "why.fast.desc": { en: "Air shipping delivers in just 7-12 days to your doorstep.", bn: "এয়ার শিপিংয়ে মাত্র ৭-১২ দিনে পণ্য পৌঁছে যায় আপনার দোরগোড়ায়।" },
  "why.bilingual.title": { en: "English + বাংলা", bn: "বাংলা + English" },
  "why.bilingual.desc": { en: "Full platform in both English and Bengali. Choose your preferred language.", bn: "সম্পূর্ণ প্ল্যাটফর্ম বাংলা ও ইংরেজি উভয় ভাষায়। আপনার পছন্দের ভাষা বেছে নিন।" },
  "why.affordable.title": { en: "Affordable Pricing", bn: "সাশ্রয়ী মূল্য" },
  "why.affordable.desc": { en: "Only 4-12% service fee. CNY at ৳15 rate. No hidden charges.", bn: "মাত্র ৪-১২% সার্ভিস ফি। CNY ১৫ টাকা রেটে। কোনো লুকানো চার্জ নেই।" },
  "why.support.title": { en: "24/7 Support", bn: "২৪/৭ সাপোর্ট" },
  "why.support.desc": { en: "Our customer support team is always here for you. Phone, WhatsApp, Messenger.", bn: "আমাদের কাস্টমার সাপোর্ট টিম সবসময় আপনার পাশে। ফোন, WhatsApp, Messenger।" },
  "why.qc.title": { en: "Quality Check", bn: "কোয়ালিটি চেক" },
  "why.qc.desc": { en: "Our China team inspects every product before shipping.", bn: "চায়নায় আমাদের টিম প্রতিটি পণ্য শিপিংয়ের আগে পরীক্ষা করে নেয়।" },

  // ─── CTA ────────────────────────────────────────
  "cta.title": { en: "Place Your First Order Today", bn: "আজই আপনার প্রথম অর্ডার করুন" },
  "cta.subtitle": { en: "Drop a Taobao or 1688 link, get a quote, and pay with bKash/Nagad. Leave the rest to us.", bn: "একটি Taobao বা 1688 লিংক দিন, কোটেশন নিন, এবং bKash/Nagad-এ পেমেন্ট করুন। বাকিটা আমাদের উপর ছেড়ে দিন。" },
  ...
  // ─── Footer ─────────────────────────────────────
  "footer.tagline": { en: "China to Bangladesh door-to-door delivery. Order from Taobao, 1688, Alibaba in English and Bengali.", bn: "চায়না থেকে বাংলাদেশে দোরগোড়ায় পণ্য ডেলিভারি। Taobao, 1688, Alibaba থেকে পণ্য অর্ডার করুন বাংলায়।" },
  ...
  "products.subtitle": { en: "Curated products from China — delivered to your doorstep", bn: "চায়না থেকে কিউরেটেড পণ্যসমূহ — সরাসরি দোরগোড়ায় ডেলিভারি" },
  ...
  // ─── Product Detail ─────────────────────────────
  "product.price": { en: "Price includes product cost, service fee, and shipping", bn: "মূল্যের মধ্যে পণ্যের দাম, সার্ভিস ফি, ও শিপিং চার্জ অন্তর্ভুক্ত" },
  ...
  "quote.subtitle": { en: "Paste a Taobao, 1688, or Alibaba product link and get an instant quote", bn: "Taobao, 1688, বা Alibaba পণ্যের লিংক দিন এবং সাথে সাথে কোটেশন নিন" },
  "quote.placeholder": { en: "https://item.taobao.com/item.htm?id=...", bn: "https://item.taobao.com/item.htm?id=..." },
  "quote.button": { en: "Get Quote", bn: "কোটেশন নিন" },
  "quote.supported": { en: "Supported: Taobao, Tmall, 1688.com — copy and paste product link", bn: "সাপোর্টেড: Taobao, Tmall, 1688.com — পণ্যের লিংক কপি করে পেস্ট করুন" },
  "quote.yourQuote": { en: "Your Quote", bn: "আপনার কোটেশন" },
  "quote.allBdt": { en: "All prices in Bangladeshi Taka (BDT)", bn: "সকল মূল্য বাংলাদেশী টাকায় (BDT)" },
  ...
  "quote.disclaimer": { en: "This is an estimated quote. Final price depends on actual weight and shipping method.", bn: "এটি আনুমানিক কোটেশন। ফাইনাল মূল্য পণ্যের ওজন ও শিপিং মেথডের উপর নির্ভর করবে।" },
  ...
  "quote.browseCatalog": { en: "Browse our catalog instead", bn: "আমাদের ক্যাটালগ থেকে পণ্য বাছাই করুন" },

  // ─── Auth ───────────────────────────────────────
  "auth.loginTitle": { en: "Login", bn: "লগইন" },
  "auth.loginSubtitle": { en: "Login with your mobile number", bn: "আপনার মোবাইল নম্বর দিয়ে লগইন করুন" },
  "auth.verifyTitle": { en: "Verify OTP", bn: "OTP ভেরিফাই করুন" },
  "auth.verifySubtitle": { en: "Enter the 6-digit code sent to your phone", bn: "আপনার মোবাইলে পাঠানো কোডটি দিন" },
  ...
  "auth.signupSubtitle": { en: "Enter your details to create an account", bn: "একাউন্ট খুলতে আপনার তথ্য দিন" },
  ...
  "auth.otpSentMsg": { en: "A verification code has been sent. Use it to login.", bn: "একটি ভেরিফিকেশন কোড পাঠানো হয়েছে। কোড দিয়ে লগইন করুন।" },
  "auth.goToLogin": { en: "Go to Login Page", bn: "লগইন পেজে যান" },

  // ─── Dashboard ──────────────────────────────────
  "dash.title": { en: "My Dashboard", bn: "আমার ড্যাশবোর্ড" },
  "dash.subtitle": { en: "Manage your orders and account", bn: "আপনার অর্ডার এবং অ্যাকাউন্ট ম্যানেজ করুন" },
  ...
  "dash.noOrdersMsg": { en: "Ready to place your first order?", bn: "আপনার প্রথম অর্ডার করতে প্রস্তুত?" },
  ...
  "dash.helpMsg": { en: "Our team is ready 24/7 for you.", bn: "আমাদের টিম ২৪/৭ আপনার জন্য প্রস্তুত。" },
  ...
  "orders.emptyMsg": { en: "You haven't placed any orders yet.", bn: "আপনার এখনো কোনো অর্ডার নেই।" },
